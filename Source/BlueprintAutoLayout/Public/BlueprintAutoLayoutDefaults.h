...
inline constexpr EBlueprintAutoLayoutRankAlignment DefaultVariableGetRankAlignment =
    DefaultRankAlignment;
inline constexpr bool DefaultPlaceVariableGetUnderDestination = false;
